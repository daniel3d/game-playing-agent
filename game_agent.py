...
def custom_score_2(game, player):
    ...
    return float(((h - y)**2 + (w - x)**2) + custom_score(game, player))
...
def custom_score_3(game, player):
    ...
    return float(len(game.get_legal_moves(player)) + custom_score_2(game, player))
    ...
    def minimax(self, game, depth, recursive=False, maximizing=True):
        ...
        **********************************************************************
        ...
        -----
            ...
            (3) Algorithm for the depth limited minimax
        ...
        if maximizing:
            ...
            for move in legal_moves:
               score, _ = self.minimax(game.forecast_move(move), depth - 1, True, False) 
               if score > best_score:
                    best_score, best_move = score, move
        else:
            best_score = float("inf")
            for move in legal_moves:
                score, _ = self.minimax(game.forecast_move(move), depth - 1, True, True)
                if score < best_score:
                    best_score, best_move = score, move
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf"), recursive=False, maximizing=True):
        ...
        **********************************************************************
        ...
        -----
            ...
            (3) Algorithm for the alpha-beta pruning 
        ...
        if maximizing:
            ...
            for move in legal_moves:
                score, _ = self.alphabeta(
                    game.forecast_move(move), depth - 1, alpha, beta, True, False) 
                if score > best_score:
                    best_score, best_move = score, move
                if best_score >= beta:
                    break
            ...
            for move in legal_moves:
                score, _ = self.alphabeta(
                    game.forecast_move(move), depth - 1, alpha, beta, True, True)
                if score < best_score:
                    best_score, best_move = score, move
                if best_score <= alpha:
                    break
